...
public class AreaNorthFeatureImpl extends AreaImpl implements Area {
    protected AreaNorthFeatureImpl(String name, String description, String searchDescription, String[] searchDirectionDesription) {
        super(name, description, searchDescription, searchDirectionDesription);
    }
