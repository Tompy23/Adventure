...
public enum CommandType {
    ...
    COMMAND_INVENTORY("Inventory", "Showing inventory"), COMMAND_MOVE("Move", "Moving"), COMMAND_NULL("", ""), COMMAND_OPEN("Open", "Opening"), COMMAND_QUIT("Quit", "Quitting"), COMMAND_RUN("Run", "Running"), // TODO
    COMMAND_SEARCH("Search", "Searching"), COMMAND_SEARCH_DIRECTION("Search", "Searching"), COMMAND_SEARCH_FEATURE("Search", "Searching"), COMMAND_SEARCH_IN("Search in", "Searching in"), // TODO
    COMMAND_SEARCH_ON("Search on", "Searching on"), // TODO
    COMMAND_TAKE("Take", "Taking"), COMMAND_TAKE_FROM("Take from", "Taking from"), COMMAND_TALK("Talk", "Talking"), COMMAND_UNEQUIP("Unequip", "Unequipping"), // TODO
